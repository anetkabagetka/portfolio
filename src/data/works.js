export const works = [
    ...
    {
        id: 5,
        title: "Easter traditions poster",
        description: "Created a poster for easter traditions in a town.",
        image: new URL('../assets/works/work18.webp', import.meta.url).href
    },
    {
        id: 6,
    ...
    },
    {
        ...
        description: "For my first semester exam project at SEA, we had to create a theatre website for a play. My role in this project was to create a visual identity, character designs proper user experience and an animated promo video. Go to <a href='https://emilka-kostenko.github.io/LionHeart'>Brothers Lionheart</a> to see the full product.",
    ...
    {
        id: 18,
        title: "Woman figure drawing",
        description: "Charcoal, from a life drawing class",
        image: new URL('../assets/works/work19.jpg', import.meta.url).href
    },
    {
        id: 19,
        title: "Man figure drawing",
        description: "Colored pencil, from a life drawing class",
        image: new URL('../assets/works/work20.jpg', import.meta.url).href
    }
];